...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    LOWER    , KC_LCTL  , KC_LALT  , KC_LGUI  , KC_INT2  , LCTL_L(KC_ENT),RAISE,            LOWER,RALT_T(KC_SPC),__________, _______ , __________, ____,KC_RALT  , KC_PSCR
  ),

  [1] = LAYOUT_universal(
    S(KC_ESC), S(KC_1)  , KC_LBRC  , S(KC_3)  , S(KC_4)  , S(KC_5)  ,                                  KC_EQL   , S(KC_6)  ,S(KC_QUOT), S(KC_8)  , S(KC_9)  ,S(KC_INT1),
    S(KC_DEL), KC_PGUP  , KC_PGDN  , KC_HOME  , KC_END)  , S(KC_T)  ,                                  S(KC_Y)  , KC_HOME  , KC_UP    , KC_DOWN  , S(KC_P)  ,S(KC_INT3),
    S(KC_TAB), S(KC_A)  , S(KC_S)  , S(KC_D)  , S(KC_F)  , S(KC_G)  ,                                  S(KC_H)  , KC_LEFT  , KC_DOWN  , KC_RGHT  , KC_QUOT  , S(KC_2)  ,
    _______  , KC_EQL   , KC_MINS  , KC_PLUS  , KC_UNDS  , S(KC_B)  ,S(KC_RBRC),           S(KC_NUHS), KC_LBRC  , KC_RBRC  ,S(KC_COMM), S(KC_DOT),S(KC_SLSH),S(KC_RSFT),
